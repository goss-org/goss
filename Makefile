...
.PHONY: all build install test release bench fmt lint vet test-int-all gen bullseye jammy alpine3 arch test-int32 bullseye-32 jammy-32 alpine3-32 arch-32
...
test-int-32: rockylinux9-32 bullseye-32 jammy-32 alpine3-32 arch-32
...
jammy-32: build
	$(info INFO: Starting build $@)
	cd integration-tests/ && ./test.sh jammy 386
alpine3-32: build
	$(info INFO: Starting build $@)
