...
release/goss-windows-amd64.exe: $(GO_FILES)
	$(info INFO: Starting build $@)
...
build: release/goss-darwin-amd64 release/goss-linux-386 release/goss-linux-amd64 release/goss-linux-arm release/goss-windows-amd64.exe
