...
community-test-%: release/goss-%
	$(info INFO: Starting build $@)
	./integration-tests/run-tests-community.sh $*

test-int-serve-%: release/goss-%
	$(info INFO: Starting build $@)
	./integration-tests/run-serve-tests.sh $*
# shim to account for linux being not in community
test-int-serve-linux-amd64: test-int-serve-community-linux-amd64
...
build: release/goss-community-darwin-amd64 release/goss-linux-386 release/goss-linux-amd64 release/goss-linux-arm release/goss-community-windows-amd64
...
test-int-darwin-all: community-test-community-darwin-amd64 test-int-serve-community-darwin-amd64
test-int-windows-all: community-test-community-windows-amd64 test-int-serve-community-windows-amd64
