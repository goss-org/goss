...
<a href="https://asciinema.org/a/bxcuduzs3n2zo62rpe1t0s6w8?autoplay=1" target="_blank"><img src="asciicast.gif" alt="asciicast"></a>
...
```bash
curl https://path/to/goss > /usr/local/bin/goss && chmod -x /usr/local/bin/goss
```
