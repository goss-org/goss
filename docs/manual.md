...
## Goss test script creation
Goss test scripts can be created by using either of following methods.
1. goss autoadd <resource to test>
2. goss add <resource to test> 
3. manually create YAML test script by hand.

To customize the parameters generated by `goss add` and `goss autoadd` YAML scripts we need to manually edit it.
