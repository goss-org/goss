...
type GomegaConsistOfMatcher struct {
	Elements        []interface{}
	missingElements []interface{}
	extraElements   []interface{}
}

func (matcher *GomegaConsistOfMatcher) Match(actual interface{}) (success bool, err error) {
...
func neighbours(value, matcher interface{}) (bool, error) {
	match, err := matcher.(types.GomegaMatcher).Match(value)
...
func gmatchers(expectedElems []interface{}) (matchers []interface{}) {
	elems := expectedElems
	...
	for _, e := range elems {
		matcher, isMatcher := e.(types.GomegaMatcher)
		if !isMatcher {
			matcher = Equal(e)
		}
...
func (matcher *GomegaConsistOfMatcher) FailureMessage(actual interface{}) (message string) {
...
func (matcher *GomegaConsistOfMatcher) NegatedFailureMessage(actual interface{}) (message string) {
