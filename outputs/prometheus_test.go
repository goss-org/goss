...
func TestPrometheusOutput(t *testing.T) {
	...
	assert.Contains(t, output, `goss_tests_outcomes_duration_seconds{outcome="skip",type="command"} 0`)
	assert.Contains(t, output, `goss_tests_outcomes_duration_seconds{outcome="pass",type="file"} 0`)
	assert.Contains(t, output, `goss_tests_outcomes_duration_seconds{outcome="fail",type="file"} 0`)
